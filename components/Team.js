        ...
        <div>
            ...
            {TeamMembers.map(member => (
                <div>
                    <h3>{member.name}</h3>
                    <p>
                        <a href={member.LinkedinURL}><img src="LinkedinLogo.png" alt="Linkedin" className={styles.logo_links} /></a>
                        <a href={member.GitHubURL}><img src="GithubLogo.png" alt="Github" className={styles.logo_links} /></a>
                    </p>
                </div>
            ))}</div>
        </div>
